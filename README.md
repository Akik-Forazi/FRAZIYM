...
- **XORZENX Framework** — A from-scratch sparse adaptive LLM architecture. HASS attention blocks, disk-sharded Mixture-of-Experts, Latent Chain-of-Thought. 277M total parameters, 26M active per token, 90% inference sparsity. The research project that founded FRAZIYM.
...
### The Team
- **Akik Faraji** — Founder & CTO. 19 years old. Self-taught. Built both XORZENX and AXONIX-ZERO alone on a laptop CPU.
...
| `xorzen.html` | XORZENX Framework — HASS architecture, sparse routing, L-CoT, variant table, verification output |
...
| `founder.html` | Akik Faraji profile — full story, why he built XORZENX, timeline |
...
| `fundraiser.html` | Community fundraiser for XORZENX GPU training — $8K goal, full transparency |
...
| XORZENX Architecture | Done · Verified · Awaiting GPU training |
| XORZENX Training | Blocked on GPU · Community fundraiser active |
| Website | Live · v3.0.0 |
...
- **Fundraiser** → [fundraiser.html](./fundraiser.html) — Help fund the XORZENX GPU training run
